...
//	}
	...
	public String boardInsert(@Validated BoardDTO boardDTO, BindResult bindResult, Model model, RedirectAttributes rttr) throws Exception {
		log.info("board/insert" + boardDTO.toString());
		
		if (bindResult.hasErros()) {
